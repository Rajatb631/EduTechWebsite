...
//                   className={`flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${activeDropdown === "courses"
//                     ? "text-green-600 bg-green-50"
//                     : "text-gray-700 hover:text-green-600 hover:bg-gray-50"
//                     }`}
//                 >
//                   Courses
//                   <ChevronDown className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "courses" ? "rotate-180" : ""
//                     }`} />
//                 </button>
...
//                   className={`flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${activeDropdown === "webdev"
//                     ? "text-green-600 bg-green-50"
//                     : "text-gray-700 hover:text-green-600 hover:bg-gray-50"
//                     }`}
//                 >
//                   Tutorials
//                   <ChevronDown className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "webdev" ? "rotate-180" : ""
//                     }`} />
//                 </button>
...
//                 className="bg-black text-white px-6 py-2 text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105">
...
//                 >
//                   Courses
//                   <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${activeDropdown === "mobile-courses" ? "rotate-180" : ""
//                     }`} />
//                 </button>
...
//                 >
//                   Tutorials
//                   <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${activeDropdown === "mobile-tutorials" ? "rotate-180" : ""
//                     }`} />
//                 </button>
                ...
                {activeDropdown === "webdev" && (
                  <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 z-50 overflow-hidden">
                    <div className="py-2">
                      ...
                      <Link to="/DsaTutorial" className="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors duration-150">
              ...
              {!user ? (
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-10 h-10 bg-green-600 text-white font-bold rounded-full flex items-center justify-center"
                  >
                    {getInitial()}
                  </button>
