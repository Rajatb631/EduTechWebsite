...
const Header = () => {
  ...
  return (
    <>
      {(activeDropdown || avatarDropdown) && <div className="fixed inset-0 z-40" onClick={handleClickOutside} />}
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative">
                ...
                >
                  Courses
                  <ChevronDown
                    className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "courses" ? "rotate-180" : ""}`}
                  />
                </button>
                {activeDropdown === "courses" && (
              ...
              <div className="relative">
                ...
                >
                  Tutorials
                  <ChevronDown
                    className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "webdev" ? "rotate-180" : ""}`}
                  />
                </button>
                {activeDropdown === "webdev" && (
                  <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 z-50 overflow-hidden">
            ...
            <div className="flex items-center space-x-3">
              ...
              {!user ? (
                <button
                  ...
                  className="bg-black text-white px-4 md:px-6 py-2 text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
                >
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-10 h-10 bg-green-600 text-white font-bold rounded-full flex items-center justify-center hover:bg-green-700 transition-colors"
                  >
                    {getInitial()}
                  </button>
            ...
            <div className="px-4 py-3 space-y-2">
              ...
              <div>
                ...
                >
                  Courses
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-200 ${activeDropdown === "mobile-courses" ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div>
                ...
                >
                  Tutorials
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-200 ${activeDropdown === "mobile-tutorials" ? "rotate-180" : ""}`}
                  />
                </button>
      ...
      />
      <LoginModal isOpen={showSignupModal} onClose={() => setShowSignupModal(false)} />
    </>
  )
}
